...
**[Download the public beta](https://github.com/PlayerEleven-11/WoW-Appearance-Expansion/releases/tag/v0.3.0-beta)** — choose **WoW-Appearance-Expansion-0.3.0-beta.zip** under Assets, not Source code.
...
Female Humans, Night Elves, Trolls and Blood Elves can use the fuller proportions while keeping classic heads and imported customization choices. The head-popping fix is included. Some female Blood Elf skins retain a lighter, makeup-like face tone. Armor and animation testing is not exhaustive. Matching NPCs and bots also use these models; the installer does not reroll them.

## Credits


- **Watchers3d, Deezhugs, and Necropheus:** original creators of the fuller (thicc) proportions.
- **castrule (Discord):** project contributor.


Proportions authorization was confirmed by PlayerEleven.
